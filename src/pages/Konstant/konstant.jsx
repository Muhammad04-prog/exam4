...
import imgMain from '../../assets/images/Rectangle 37 (5).png';
import imgOverlap1 from '../../assets/images/Rectangle 189 (4).png';
import imgOverlap2 from '../../assets/images/Rectangle 190 (4).png'; 
import imgVideo from '../../assets/images/Rectangle 112 (1).png';
  ...
  return (
    <Box sx={{ position: 'relative', height: { xs: '400px', md: '600px' }, width: '100%', bgcolor: '#f5f5f5', overflow: 'hidden' }}>
      ...
      <Box sx={{position: 'absolute', bottom: 0, left: 0, right: 0, height: '50%',background: 'linear-gradient(to top, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0) 100%)',display: 'flex',flexDirection: 'column',justifyContent: 'flex-end',p: { xs: 3, md: 6, lg: 10 }}}>
        ...
        >
          <Typography sx={{ color: 'white',fontSize: { xs: '1rem', md: '1.25rem' },mb: 1 }}>Загородные частные дома</Typography>
          <Typography variant="h2" sx={{ fontWeight: 900, fontSize: { xs: '2.5rem', md: '4.5rem', lg: '5.5rem' },lineHeight: 1,textTransform: 'uppercase'}}>
            <Box component="span" sx={{ color: '#F2A359' }}>КОНСТАНТИНОВКА</Box>
          </Typography>
        </motion.div>
      </Box>
    </Box>
        ...
        <Box sx={{ width: { xs: '100%', md: '50%' } }}>
          ...
          >
            <Typography sx={{ mb: 5, fontSize: '1.05rem', lineHeight: 1.6, color: '#333' }}>
              Константиновка - это проект для строительства частных домов на территории поселка Константиновка (г. Казань).
            </Typography>
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 6 }}>
          <Typography variant="h4" component="h2" sx={{ fontWeight: 'bold', textTransform: 'uppercase' }}>
            <Box component="span" sx={{ color: '#F2A359' }}>ВИДЕО </Box>
            О ПРОЕКТЕ
          </Typography>
        </Box>
        <Box 
        ...
        >
          <img src={imgVideo} alt="Video Thumbnail" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
          <Box 
            sx={{ 
          ...
          >
            <motion.div
              ...
              whileTap={{ scale: 0.9 }}
              sx={{ width: '80px', height: '80px', borderRadius: '50%', border: '2px solid white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
            >
...
export default function Konstant() {
