...
import imgMain from '../../assets/images/Rectangle 37 (7).png'; 
import imgOverlap1 from '../../assets/images/Rectangle 189 (3).png';
import imgOverlap2 from '../../assets/images/Rectangle 190 (3).png'; 
      ...
      <Box sx={{position: 'absolute', bottom: 0, left: 0, right: 0, height: '50%',background: 'linear-gradient(to top, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0) 100%)',display: 'flex',flexDirection: 'column',justifyContent: 'flex-end',p: { xs: 3, md: 6, lg: 10 }}}>
        ...
        >
          ...
          <Typography variant="h2" sx={{ fontWeight: 900, fontSize: { xs: '2.5rem', md: '4.5rem', lg: '5.5rem' },lineHeight: 1,textTransform: 'uppercase'}}>
            <Box component="span" sx={{ color: '#F2A359' }}>ЗИМНЯЯ </Box>
            <Box component="span" sx={{ color: 'white' }}>ГОРКА</Box>
          </Typography>
        </motion.div>
      </Box>
    </Box>
...
const ZimAbout = () => {
  const features = [
    ...
    { icon: <LocationCityOutlinedIcon sx={{ fontSize: 32, color: '#555' }} />, text: 'Подведение всех коммуникаций' },
        ...
        <Box sx={{ width: { xs: '100%', md: '50%' } }}>
          ...
          >
            <Typography sx={{ mb: 5, fontSize: '1.05rem', lineHeight: 1.6, color: '#333' }}>
              Зимняя Горка - это проект для строительства частных домов на территории поселка Зимняя Горка (г. Казань).
            </Typography>
